...
(() => {
  ...
  var require_r = __commonJS({
    "rg:r"(exports, module) {
      ...
      function jsx3(t, p, k3) {
        return window.React.createElement(t, k3 === void 0 ? p : Object.assign({ key: k3 }, p));
      }
      module.exports = new Proxy({ jsx: jsx3, jsxs: jsx3, jsxDEV: jsx3, Fragment: void 0 }, {
        get: function(o, k3) {
...
Source string: ${className}`);
  ...
  init_define_import_meta_env();
  var import_jsx_runtime = __toESM(require_r(), 1);
  var import_react = __toESM(require_r(), 1);
  ...
  init_define_import_meta_env();
  var import_jsx_runtime2 = __toESM(require_r(), 1);
  var import_react2 = __toESM(require_r(), 1);
...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  init_define_import_meta_env();
  var ReactRuntime = __toESM(require_r());
  ...
  // node_modules/@fluentui/react-jsx-runtime/lib/jsx-runtime.js
  var import_react3 = __toESM(require_r());
  ...
  var createHighContrastTheme = () => {
    const colorTokens = generateColorTokens2();
    return {
      ...borderRadius,
      ...fontSizes,
      ...lineHeights,
  ...
  init_define_import_meta_env();
  var highContrastTheme = teamsHighContrastTheme;

  // .storybook/preview.tsx
  var import_jsx_runtime4 = __toESM(require_r());
  var withFluentProvider = (Story, context) => {
    const bg = context.globals?.backgrounds?.value;
    const isHighContrast = bg === "#000000";
    const isDark = bg === "#333333";
    const theme = isHighContrast ? highContrastTheme : isDark ? darkTheme : lightTheme;
    const dir = context.globals?.direction ?? "ltr";
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme, dir, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { padding: "1rem", background: "#fff" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Story, {}) }) });
  };
  var preview = {
