...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  var ds_TextField_default = g["TextField"] !== void 0 ? g["TextField"] : g;
  ...
  var meta = {
    ...
    component: ds_TextField_exports.TextField,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var Required2 = (
    /* Required */
    compose(TextField_stories_exports, "Required")
  );
  var ErrorState2 = (
    /* Error State */
    compose(TextField_stories_exports, "ErrorState")
  );
  var SuccessState2 = (
    /* Success State */
    compose(TextField_stories_exports, "SuccessState")
  );
  var WarningState2 = (
    /* Warning State */
    compose(TextField_stories_exports, "WarningState")
  );
  var WithCharCount2 = (
    /* With Char Count */
    compose(TextField_stories_exports, "WithCharCount")
  );
  var Small2 = (
    /* Small */
    compose(TextField_stories_exports, "Small")
  );
  var DarkMode2 = (
    /* Dark Mode */
    compose(TextField_stories_exports, "DarkMode")
  );
  var RTL2 = (
    /* RTL */
    compose(TextField_stories_exports, "RTL")
  );
