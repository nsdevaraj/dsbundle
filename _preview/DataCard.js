...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/DataCard.tsx
  var DataCard_exports = {};
  __export(DataCard_exports, {
    MinimalNoIcon: () => MinimalNoIcon2,
    WithDescription: () => WithDescription2,
    WithTrendDown: () => WithTrendDown2,
    WithTrendUp: () => WithTrendUp2
  });
  init_define_import_meta_env();
  var React4 = __toESM(require_react_shim());

  // src/stories/DataCard.stories.tsx
  var DataCard_stories_exports = {};
  __export(DataCard_stories_exports, {
    MinimalNoIcon: () => MinimalNoIcon,
    WithDescription: () => WithDescription,
    WithTrendDown: () => WithTrendDown,
    WithTrendUp: () => WithTrendUp,
    default: () => DataCard_stories_default
  });
  init_define_import_meta_env();
...
Source string: ${className}`);
  ...
  init_define_import_meta_env();
  var Clock20Regular = /* @__PURE__ */ createFluentIcon("Clock20Regular", "20", ["M10 2a8 8 0 1 1 0 16 8 8 0 0 1 0-16Zm0 1a7 7 0 1 0 0 14 7 7 0 0 0 0-14Zm-.5 2a.5.5 0 0 1 .5.41V10h2.5a.5.5 0 0 1 .09 1H9.5a.5.5 0 0 1-.5-.41V5.5c0-.28.22-.5.5-.5Z"]);

  // node_modules/@fluentui/react-icons/lib/sizedIcons/chunk-24.js
  init_define_import_meta_env();
  var Checkmark20Regular = /* @__PURE__ */ createFluentIcon("Checkmark20Regular", "20", ["M3.37 10.17a.5.5 0 0 0-.74.66l4 4.5c.19.22.52.23.72.02l10.5-10.5a.5.5 0 0 0-.7-.7L7.02 14.27l-3.65-4.1Z"]);
  ...
  var ds_DataCard_default = g["DataCard"] !== void 0 ? g["DataCard"] : g;

  // src/stories/DataCard.stories.tsx
  var import_jsx_runtime3 = __toESM(require_react_shim());
  var meta = {
    title: "Components/DataCard",
    component: ds_DataCard_exports.DataCard,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var DataCard_stories_default = meta;
  var WithTrendUp = {
    args: { label: "Total Users", value: "1,284", trend: "+12%", trendUp: true, icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(People20Regular, {}) }
  };
  var WithTrendDown = {
    args: { label: "Active Sessions", value: "392", trend: "-8%", trendUp: false, icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Clock20Regular, {}) }
  };
  var WithDescription = {
    args: { label: "Completed Tasks", value: "312", description: "This quarter", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Checkmark20Regular, {}) }
  };
  var MinimalNoIcon = {
  ...
  var WithTrendUp2 = (
    /* With Trend Up */
    compose(DataCard_stories_exports, "WithTrendUp")
  );
  var WithTrendDown2 = (
    /* With Trend Down */
    compose(DataCard_stories_exports, "WithTrendDown")
  );
  var WithDescription2 = (
    /* With Description */
    compose(DataCard_stories_exports, "WithDescription")
  );
  var MinimalNoIcon2 = (
    /* Minimal No Icon */
    compose(DataCard_stories_exports, "MinimalNoIcon")
  );
  return __toCommonJS(DataCard_exports);
})();
