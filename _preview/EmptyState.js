...
var __dsPreview = (() => {
  ...
  __export(EmptyState_exports, {
    EmptyFolder: () => EmptyFolder2,
    NoDocuments: () => NoDocuments2,
  ...
  var EmptyState_stories_exports = {};
  __export(EmptyState_stories_exports, {
    EmptyFolder: () => EmptyFolder,
    NoDocuments: () => NoDocuments,
    NoResults: () => NoResults,
    default: () => EmptyState_stories_default
  });
  init_define_import_meta_env();
...
Be sure to create slots properly by using "slot.always" or "slot.optional" with the correct elementType.`);
  ...
  var CustomStyleHooksContext = React5.createContext(void 0);
  var noop = () => {
  };
  ...
  var useCustomStyleHook = (hook) => {
    ...
    return (_React_useContext_hook = (_React_useContext = React5.useContext(CustomStyleHooksContext)) === null || _React_useContext === void 0 ? void 0 : _React_useContext[hook]) !== null && _React_useContext_hook !== void 0 ? _React_useContext_hook : noop;
  };
  ...
  // node_modules/@fluentui/react-utilities/lib/hooks/useIsomorphicLayoutEffect.js
  var useIsomorphicLayoutEffect = canUseDOM2() ? React6.useLayoutEffect : React6.useEffect;

  // node_modules/@fluentui/react-utilities/lib/hooks/useEventCallback.js
  var useEventCallback = (fn) => {
    const callbackRef = React7.useRef(() => {
...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  var jsxSlot = (type, overrideProps, key) => {
    ...
    if (renderFunction) {
      return Runtime.jsx(React8.Fragment, {
  ...
  var jsxsSlot = (type, overrideProps, key) => {
    ...
    if (renderFunction) {
      return Runtime.jsx(React9.Fragment, {
        children: renderFunction(elementType, {
          ...props,
          children: Runtime.jsxs(React9.Fragment, {
  ...
  var buttonContext = React10.createContext(void 0);
  var buttonContextDefaultValue = {};
  var ButtonContextProvider = buttonContext.Provider;
  var useButtonContext = () => {
    var _React_useContext;
    return (_React_useContext = React10.useContext(buttonContext)) !== null && _React_useContext !== void 0 ? _React_useContext : buttonContextDefaultValue;
  };
  ...
  // node_modules/@fluentui/react-button/lib/components/Button/Button.js
  var Button = /* @__PURE__ */ React11.forwardRef((props, ref) => {
  ...
  var ds_EmptyState_default = g["EmptyState"] !== void 0 ? g["EmptyState"] : g;
  ...
  var EmptyState_stories_default = meta;
  var NoResults = {
    args: {
      icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Search48Regular, {}),
      title: "No results found",
      description: "Try adjusting your search or filters to find what you're looking for.",
      action: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button, { appearance: "primary", children: "Clear filters" })
    }
  };
  var EmptyFolder = {
    args: {
      icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FolderOpenRegular, {}),
      title: "This folder is empty",
      description: "Upload files or create a new document to get started.",
      action: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button, { appearance: "primary", children: "Upload files" })
    }
  };
  var NoDocuments = {
    args: {
      icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DocumentRegular, {}),
  ...
  function compose(S, key) {
    ...
    if (st && typeof st.render === "function") render = () => st.render(args, ctx);
      ...
      if (C) render = () => React12.createElement(C, args);
    }
  ...
  var NoResults2 = (
    /* No Results */
    compose(EmptyState_stories_exports, "NoResults")
  );
  var EmptyFolder2 = (
    /* Empty Folder */
    compose(EmptyState_stories_exports, "EmptyFolder")
  );
  var NoDocuments2 = (
    /* No Documents */
    compose(EmptyState_stories_exports, "NoDocuments")
  );
