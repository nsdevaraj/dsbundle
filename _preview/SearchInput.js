...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/SearchInput.tsx
  var SearchInput_exports = {};
  __export(SearchInput_exports, {
    Debounced: () => Debounced2,
    Default: () => Default2,
    Disabled: () => Disabled2
  });
  init_define_import_meta_env();
  ...
  var SearchInput_stories_exports = {};
  __export(SearchInput_stories_exports, {
    Debounced: () => Debounced,
    Default: () => Default,
    Disabled: () => Disabled,
    default: () => SearchInput_stories_default
  });
  init_define_import_meta_env();
  ...
  var ds_SearchInput_default = g["SearchInput"] !== void 0 ? g["SearchInput"] : g;

  // src/stories/SearchInput.stories.tsx
  var import_jsx_runtime = __toESM(require_react_shim());
  var meta = {
    title: "Components/SearchInput",
    component: ds_SearchInput_exports.SearchInput,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var SearchInput_stories_default = meta;
  var Default = {
    render: () => {
      const [q, setQ] = (0, import_react.useState)("");
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: tokens.spacingVerticalS }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_SearchInput_exports.SearchInput, { onSearch: setQ, placeholder: "Search projects…" }),
        q && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: tokens.fontSizeBase200, color: tokens.colorNeutralForeground3 }, children: [
          "Query: ",
          q
        ] })
      ] });
  ...
  var Debounced = {
    render: () => {
      const [q, setQ] = (0, import_react.useState)("");
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: tokens.spacingVerticalS }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_SearchInput_exports.SearchInput, { onSearch: setQ, placeholder: "Search (300ms debounce)…", debounceMs: 300 }),
        q && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: tokens.fontSizeBase200, color: tokens.colorNeutralForeground3 }, children: [
          "Debounced: ",
          q
        ] })
  ...
  var Disabled = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_SearchInput_exports.SearchInput, { onSearch: () => {
    }, placeholder: "Disabled search", disabled: true })
  };
  ...
  var Default2 = (
    /* Default */
    compose(SearchInput_stories_exports, "Default")
  );
  var Debounced2 = (
    /* Debounced */
    compose(SearchInput_stories_exports, "Debounced")
  );
  var Disabled2 = (
    /* Disabled */
    compose(SearchInput_stories_exports, "Disabled")
  );
