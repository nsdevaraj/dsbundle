...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  function DrawerDemo({ position, size, title, subtitle }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button, { appearance: "primary", onClick: () => setOpen(true), children: "Open Drawer" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        ds_Drawer_exports.Drawer,
        {
          open,
          ...
          footer: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button, { appearance: "primary", onClick: () => setOpen(false), children: "Save" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button, { onClick: () => setOpen(false), children: "Cancel" })
          ] }),
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: "Drawer body content goes here." }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: "Add form fields, details, or any content." })
          ]
        }
      )
    ] });
  ...
  var Default = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DrawerDemo, {})
  };
  var Start = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DrawerDemo, { position: "start", title: "Left Drawer" })
  };
  var Small = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DrawerDemo, { size: "small", title: "Small Drawer" })
  };
  var Large = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DrawerDemo, { size: "large", title: "Large Drawer" })
  };
  var WithSubtitle = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DrawerDemo, { title: "Edit User", subtitle: "Modify user account details" })
  };
  ...
  var Start2 = (
    /* Start */
    compose(Drawer_stories_exports, "Start")
  );
  var Small2 = (
    /* Small */
    compose(Drawer_stories_exports, "Small")
  );
  var Large2 = (
    /* Large */
  ...
  var WithSubtitle2 = (
    /* With Subtitle */
    compose(Drawer_stories_exports, "WithSubtitle")
  );
