...
var __dsPreview = (() => {
  ...
  __export(FileUpload_exports, {
    ...
    WithSizeLimit: () => WithSizeLimit2
  });
  init_define_import_meta_env();
  var React = __toESM(require_react_shim());

  // src/stories/FileUpload.stories.tsx
  var FileUpload_stories_exports = {};
  __export(FileUpload_stories_exports, {
    ...
    Required: () => Required,
    WithError: () => WithError,
    WithSizeLimit: () => WithSizeLimit,
    default: () => FileUpload_stories_default
  });
  init_define_import_meta_env();
  ...
  var meta = {
    ...
    component: ds_FileUpload_exports.FileUpload,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var FileUpload_stories_default = meta;
  var Default = {
  ...
  var Default2 = (
    /* Default */
    compose(FileUpload_stories_exports, "Default")
  );
  var Multiple2 = (
    /* Multiple */
    compose(FileUpload_stories_exports, "Multiple")
  );
  var WithSizeLimit2 = (
    /* With Size Limit */
    compose(FileUpload_stories_exports, "WithSizeLimit")
  );
  var Required2 = (
    /* Required */
    compose(FileUpload_stories_exports, "Required")
  );
  var Disabled2 = (
    /* Disabled */
    compose(FileUpload_stories_exports, "Disabled")
  );
  var WithError2 = (
    /* With Error */
    compose(FileUpload_stories_exports, "WithError")
  );
  var CustomPrompt2 = (
    /* Custom Prompt */
    compose(FileUpload_stories_exports, "CustomPrompt")
  );
