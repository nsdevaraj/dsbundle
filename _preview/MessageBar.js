...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MessageBar.tsx
  var MessageBar_exports = {};
  __export(MessageBar_exports, {
  ...
  // src/stories/MessageBar.stories.tsx
  var MessageBar_stories_exports = {};
  __export(MessageBar_stories_exports, {
    ...
    default: () => MessageBar_stories_default
  });
  init_define_import_meta_env();
  ...
  var MessageBar_stories_default = meta;
  var Info = {
  ...
  var Info2 = (
    /* Info */
    compose(MessageBar_stories_exports, "Info")
  );
  var Success2 = (
    /* Success */
    compose(MessageBar_stories_exports, "Success")
  );
  var Warning2 = (
    /* Warning */
    compose(MessageBar_stories_exports, "Warning")
  );
  var Error3 = (
    /* Error */
    compose(MessageBar_stories_exports, "Error")
  );
  var Dismissible2 = (
    /* Dismissible */
    compose(MessageBar_stories_exports, "Dismissible")
  );
  var WithActions2 = (
    /* With Actions */
    compose(MessageBar_stories_exports, "WithActions")
  );
  return __toCommonJS(MessageBar_exports);
})();
