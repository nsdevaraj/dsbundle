...
var __dsPreview = (() => {
  ...
  var items = [
    { value: "a", header: "What is Fluent 2?", content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Fluent 2 is Microsoft's design system." }) },
    { value: "b", header: "How do I use tokens?", content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Import tokens and reference them in makeStyles." }) },
    { value: "c", header: "Disabled panel", content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "You shouldn't see this." }), disabled: true }
  ];
  var Default = {
    args: { items }
  };
  ...
  var Multiple2 = (
    /* Multiple */
    compose(Accordion_stories_exports, "Multiple")
  );
  var FilledDarker2 = (
    /* Filled Darker */
    compose(Accordion_stories_exports, "FilledDarker")
  );
  var FilledAlternative2 = (
    /* Filled Alternative */
    compose(Accordion_stories_exports, "FilledAlternative")
  );
