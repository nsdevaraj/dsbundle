...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/Stepper.tsx
  var Stepper_exports = {};
  __export(Stepper_exports, {
    AllCompleted: () => AllCompleted2,
    Default: () => Default2,
    Vertical: () => Vertical2,
  ...
  var Stepper_stories_exports = {};
  __export(Stepper_stories_exports, {
    AllCompleted: () => AllCompleted,
    Default: () => Default,
    Vertical: () => Vertical,
    WithError: () => WithError,
    default: () => Stepper_stories_default
  });
  init_define_import_meta_env();
  ...
  var meta = {
    ...
    component: ds_Stepper_exports.Stepper,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var Stepper_stories_default = meta;
  var steps = [
    { label: "Account", description: "Create your account", status: "completed" },
    { label: "Profile", description: "Add your details", status: "current" },
    { label: "Review", description: "Confirm everything", status: "upcoming" },
  ...
  var WithError = {
    args: {
      steps: [
        ...
        { label: "Verify", status: "error", description: "Verification failed" },
        { label: "Profile", status: "upcoming" }
      ]
    }
  };
  var AllCompleted = {
  ...
  var Default2 = (
    /* Default */
    compose(Stepper_stories_exports, "Default")
  );
  var Vertical2 = (
    /* Vertical */
    compose(Stepper_stories_exports, "Vertical")
  );
  var WithError2 = (
    /* With Error */
    compose(Stepper_stories_exports, "WithError")
  );
  var AllCompleted2 = (
    /* All Completed */
    compose(Stepper_stories_exports, "AllCompleted")
  );
