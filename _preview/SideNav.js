...
var __dsPreview = (() => {
  ...
  __export(SideNav_exports, {
    ...
    CollapsedRTL: () => CollapsedRTL2,
    DarkMode: () => DarkMode2,
    Default: () => Default2,
    RTL: () => RTL2,
    RTLCollapsed: () => RTLCollapsed2,
    WithGroups: () => WithGroups2
  });
  init_define_import_meta_env();
  var React23 = __toESM(require_react_shim());

  // src/stories/SideNav.stories.tsx
  var SideNav_stories_exports = {};
  __export(SideNav_stories_exports, {
    Collapsed: () => Collapsed,
    CollapsedRTL: () => CollapsedRTL,
    DarkMode: () => DarkMode,
    Default: () => Default,
    RTL: () => RTL,
    RTLCollapsed: () => RTLCollapsed,
...
Be sure to create slots properly by using "slot.always" or "slot.optional" with the correct elementType.`);
  ...
  var ThemeClassNameContext = React4.createContext(void 0);
  ...
  var TooltipVisibilityContext = React5.createContext(void 0);
  ...
  var ProviderContext = React6.createContext(void 0);
  ...
  function useFluent() {
    ...
    return (_React_useContext = React6.useContext(ProviderContext)) !== null && _React_useContext !== void 0 ? _React_useContext : providerContextDefaultValue;
  }
  ...
  var OverridesContext = React7.createContext(void 0);
  var OverridesProvider = OverridesContext.Provider;
  function useOverrides() {
    var _React_useContext;
    return (_React_useContext = React7.useContext(OverridesContext)) !== null && _React_useContext !== void 0 ? _React_useContext : {};
  }
  ...
  var CustomStyleHooksContext = React8.createContext(void 0);
  ...
  function useSSRContext() {
    var _React_useContext;
    return (_React_useContext = React9.useContext(SSRContext)) !== null && _React_useContext !== void 0 ? _React_useContext : defaultSSRContextValue;
  }
...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  var IconDirectionContext = React15.createContext(void 0);
  var IconDirectionContextDefaultValue = {};
  var IconDirectionContextProvider = IconDirectionContext.Provider;
  var useIconContext = () => {
    const context = React15.useContext(IconDirectionContext);
  ...
  function useFocusVisible(options = {}) {
    ...
    const scopeRef = React16.useRef(null);
  ...
  // node_modules/@fluentui/react-provider/lib/components/FluentProvider/useFluentProviderThemeStyleTag.js
  var useInsertionEffect3 = React17["useInsertionEffect"] ? React17["useInsertionEffect"] : useIsomorphicLayoutEffect;
  ...
  var useFluentProviderThemeStyleTag = (options) => {
    ...
    const styleTag = React17.useRef(void 0);
    const styleTagId = useId2(fluentProviderClassNames.root);
    const styleElementAttributes = rendererAttributes;
    const rule = React17.useMemo(() => createCSSRuleFromTheme(`.${styleTagId}`, theme), [
      theme,
      styleTagId
    ]);
    if (true) {
  ...
  var useFluentProvider_unstable = (props, ref) => {
    ...
    const parentCustomStyleHooks = React18.useContext(CustomStyleHooksContext) || DEFAULT_STYLE_HOOKS;
    const {
  ...
  function useTheme() {
    return React18.useContext(ThemeContext);
  }
  ...
  function useFluentProviderContextValues_unstable(state) {
    ...
    const provider = React19.useMemo(() => ({
      dir,
      targetDocument
    }), [
      dir,
    ...
    const [tooltip] = React19.useState(() => ({}));
    const iconDirection = React19.useMemo(() => ({
      textDirection: dir
    }), [
      dir
    ]);
  ...
  // node_modules/@fluentui/react-provider/lib/components/FluentProvider/FluentProvider.js
  var FluentProvider = /* @__PURE__ */ React20.forwardRef((props, ref) => {
  ...
  var renderSvgNode = (node, key) => {
    ...
    return React21.createElement(tag, { ...attrs, key }, ...children.map(renderSvgNode));
  };
  var createFluentIcon = (displayName, width, pathsOrSvg, options) => {
    ...
    const Icon2 = React21.forwardRef((props, ref) => {
      ...
      if (typeof pathsOrSvg === "string") {
        return React21.createElement("svg", { ...state, dangerouslySetInnerHTML: { __html: pathsOrSvg } });
      }
      if (colorChildren) {
        return React21.createElement("svg", state, ...colorChildren);
      }
      return React21.createElement("svg", state, ...pathsOrSvg.map((d) => React21.createElement("path", { d, fill: state.fill })));
    });
  ...
  var items = [
    { id: "home", label: "Home", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Home20Regular, {}) },
    { id: "reports", label: "Reports", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChartMultiple20Regular, {}), children: [
      { id: "sales", label: "Sales" },
      { id: "usage", label: "Usage" }
    ] },
    { id: "people", label: "People", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(People20Regular, {}) },
    { id: "docs", label: "Documents", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DocumentMultiple20Regular, {}) },
    { id: "settings", label: "Settings", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Settings20Regular, {}), disabled: true }
  ];
  function NavDemo({ collapsed }) {
    const [selected, setSelected] = (0, import_react12.useState)("home");
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { height: "400px", display: "flex" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_SideNav_exports.SideNav, { items, selectedId: selected, onSelect: setSelected, collapsed }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { padding: "16px" }, children: [
        "Selected: ",
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { children: selected })
      ] })
    ] });
  }
  var meta = {
  ...
  var Default = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(NavDemo, {})
  };
  var Collapsed = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(NavDemo, { collapsed: true })
  };
  var RTL = {
    render: () => {
      const [selected, setSelected] = (0, import_react12.useState)("home");
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme: webLightTheme, dir: "rtl", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { height: "400px", display: "flex", direction: "rtl" }, children: [
  ...
  var CollapsedRTL = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme: webLightTheme, dir: "rtl", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { height: "400px", display: "flex", direction: "rtl" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_SideNav_exports.SideNav, { items, selectedId: "home", collapsed: true }) }) })
  };
  var WithGroups = {
    render: () => {
      const [selected, setSelected] = (0, import_react12.useState)("home");
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { height: "400px", display: "flex" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        ds_SideNav_exports.SideNav,
        {
          groups: [
            { label: "Main", items: [
              { id: "home", label: "Home", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Home20Regular, {}) },
              { id: "reports", label: "Reports", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChartMultiple20Regular, {}) }
            ] },
            { label: "Admin", items: [
              { id: "people", label: "People", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(People20Regular, {}) },
              { id: "settings", label: "Settings", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Settings20Regular, {}) }
            ] }
          ],
          selectedId: selected,
          onSelect: setSelected
  ...
  var navItems = [
    { key: "home", label: "Home", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Home20Regular, {}) },
    { key: "reports", label: "Reports", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChartMultiple20Regular, {}), active: true },
    { key: "settings", label: "Settings", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Settings20Regular, {}) }
  ];
  var DarkMode = {
    decorators: [(Story) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme: darkTheme, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Story, {}) })],
    args: { items: navItems, activeKey: "reports" }
  };
  var RTLCollapsed = {
    decorators: [(Story) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme: {}, dir: "rtl", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Story, {}) })],
  ...
  function compose(S, key) {
    ...
    if (st && typeof st.render === "function") render = () => st.render(args, ctx);
      ...
      if (C) render = () => React23.createElement(C, args);
    }
  ...
  var Collapsed2 = (
    /* Collapsed */
    compose(SideNav_stories_exports, "Collapsed")
  );
  var RTL2 = (
    /* RTL */
    compose(SideNav_stories_exports, "RTL")
  );
  var CollapsedRTL2 = (
    /* Collapsed RTL */
    compose(SideNav_stories_exports, "CollapsedRTL")
  );
  var WithGroups2 = (
    /* With Groups */
    compose(SideNav_stories_exports, "WithGroups")
  );
  var DarkMode2 = (
    /* Dark Mode */
    compose(SideNav_stories_exports, "DarkMode")
  );
  var RTLCollapsed2 = (
    /* RTL Collapsed */
    compose(SideNav_stories_exports, "RTLCollapsed")
  );
