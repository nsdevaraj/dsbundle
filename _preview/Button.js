...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  var createFluentIcon = (displayName, width, pathsOrSvg, options) => {
    ...
    const Icon = React21.forwardRef((props, ref) => {
  ...
  init_define_import_meta_env();
  var Save20Regular = /* @__PURE__ */ createFluentIcon("Save20Regular", "20", ["M3 5c0-1.1.9-2 2-2h8.38a2 2 0 0 1 1.41.59l1.62 1.62A2 2 0 0 1 17 6.62V15a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5Zm2-1a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1v-4.5c0-.83.67-1.5 1.5-1.5h7c.83 0 1.5.67 1.5 1.5V16a1 1 0 0 0 1-1V6.62a1 1 0 0 0-.3-.7L14.1 4.28a1 1 0 0 0-.71-.29H13v2.5c0 .83-.67 1.5-1.5 1.5h-4A1.5 1.5 0 0 1 6 6.5V4H5Zm2 0v2.5c0 .28.22.5.5.5h4a.5.5 0 0 0 .5-.5V4H7Zm7 12v-4.5a.5.5 0 0 0-.5-.5h-7a.5.5 0 0 0-.5.5V16h8Z"]);

  // node_modules/@fluentui/react-icons/lib/sizedIcons/chunk-13.js
  init_define_import_meta_env();
  var Add20Regular = /* @__PURE__ */ createFluentIcon("Add20Regular", "20", ["M10 2.5c.28 0 .5.22.5.5v6.5H17a.5.5 0 0 1 0 1h-6.5V17a.5.5 0 0 1-1 0v-6.5H3a.5.5 0 0 1 0-1h6.5V3c0-.28.22-.5.5-.5Z"]);
  ...
  var WithIcon = {
    args: { appearance: "primary", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Add20Regular, {}), children: "Add item" }
  };
  var IconAfter = {
    args: { appearance: "secondary", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Save20Regular, {}), iconPosition: "after", children: "Save" }
  };
  var Loading = {
  ...
  var IconOnly = {
    args: { appearance: "subtle", icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Add20Regular, {}), "aria-label": "Add item" }
  };
  var DarkMode = {
    decorators: [(Story) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme: darkTheme, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { padding: "1rem", display: "flex", gap: "8px" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Story, {}) }) })],
    args: { children: "Submit", appearance: "primary" }
  };
  var RTL = {
    decorators: [(Story) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme: {}, dir: "rtl", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { padding: "1rem" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Story, {}) }) })],
  ...
  function compose(S, key) {
    ...
    if (st && typeof st.render === "function") render = () => st.render(args, ctx);
      ...
      if (C) render = () => React22.createElement(C, args);
    }
  ...
  var Subtle2 = (
    /* Subtle */
    compose(Button_stories_exports, "Subtle")
  );
  var WithIcon2 = (
    /* With Icon */
    compose(Button_stories_exports, "WithIcon")
  );
  var IconAfter2 = (
    /* Icon After */
    compose(Button_stories_exports, "IconAfter")
  );
  var Loading2 = (
    /* Loading */
    compose(Button_stories_exports, "Loading")
  );
  var Disabled2 = (
    /* Disabled */
    compose(Button_stories_exports, "Disabled")
  );
  var Small2 = (
    /* Small */
    compose(Button_stories_exports, "Small")
  );
  var IconOnly2 = (
    /* Icon Only */
    compose(Button_stories_exports, "IconOnly")
  );
  var DarkMode2 = (
    /* Dark Mode */
    compose(Button_stories_exports, "DarkMode")
  );
  var RTL2 = (
    /* RTL */
    compose(Button_stories_exports, "RTL")
  );
