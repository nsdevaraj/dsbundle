...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/SplitButton.tsx
  ...
  // src/stories/SplitButton.stories.tsx
  var SplitButton_stories_exports = {};
  __export(SplitButton_stories_exports, {
    Disabled: () => Disabled,
    Outline: () => Outline,
    Primary: () => Primary,
    Secondary: () => Secondary,
    Small: () => Small,
    WithIcon: () => WithIcon,
    default: () => SplitButton_stories_default
  });
  init_define_import_meta_env();
...
Source string: ${className}`);
  ...
  var ds_SplitButton_default = g["SplitButton"] !== void 0 ? g["SplitButton"] : g;

  // src/stories/SplitButton.stories.tsx
  var import_jsx_runtime3 = __toESM(require_react_shim());
  var meta = {
    title: "Components/SplitButton",
    component: ds_SplitButton_exports.SplitButton,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var SplitButton_stories_default = meta;
  var items = [
    { id: "save", label: "Save" },
  ...
  var WithIcon = {
    args: { label: "Save", appearance: "primary", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Save20Regular, {}), items }
  };
  var Disabled = {
  ...
  var Primary2 = (
    /* Primary */
    compose(SplitButton_stories_exports, "Primary")
  );
  var Secondary2 = (
    /* Secondary */
    compose(SplitButton_stories_exports, "Secondary")
  );
  var Outline2 = (
    /* Outline */
    compose(SplitButton_stories_exports, "Outline")
  );
  var WithIcon2 = (
    /* With Icon */
    compose(SplitButton_stories_exports, "WithIcon")
  );
  var Disabled2 = (
    /* Disabled */
    compose(SplitButton_stories_exports, "Disabled")
  );
  var Small2 = (
    /* Small */
    compose(SplitButton_stories_exports, "Small")
  );
  return __toCommonJS(SplitButton_exports);
})();
