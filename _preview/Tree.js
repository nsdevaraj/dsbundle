...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/Tree.tsx
  var Tree_exports = {};
  ...
  var Tree_stories_exports = {};
  __export(Tree_stories_exports, {
    Default: () => Default,
    FlatList: () => FlatList,
    MultiSelect: () => MultiSelect,
    SingleSelect: () => SingleSelect,
    Small: () => Small,
    default: () => Tree_stories_default
  });
  init_define_import_meta_env();
...
Source string: ${className}`);
  ...
  var ds_Tree_default = g["Tree"] !== void 0 ? g["Tree"] : g;

  // src/stories/Tree.stories.tsx
  var import_jsx_runtime3 = __toESM(require_react_shim());
  var meta = {
    title: "Components/Tree",
    component: ds_Tree_exports.Tree,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var Tree_stories_default = meta;
  var fileTree = [
    {
      id: "src",
      label: "src",
      icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Folder20Regular, {}),
      children: [
        {
          id: "components",
          label: "components",
          icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(FolderOpen20Regular, {}),
          children: [
            { id: "button", label: "Button.tsx", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) },
            { id: "input", label: "TextField.tsx", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) }
          ]
        },
        { id: "app", label: "App.tsx", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) },
        { id: "index", label: "index.tsx", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) }
      ]
    },
    { id: "package", label: "package.json", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) },
    { id: "tsconfig", label: "tsconfig.json", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) }
  ];
  var Default = {
  ...
  var MultiSelect = {
    render: () => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
        ...
        selected.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { style: { marginTop: 8, fontSize: 13 }, children: [
          "Selected: ",
          selected.join(", ")
        ] })
      ] });
  ...
  var FlatList = {
    args: {
      ...
      items: [
        { id: "a", label: "Item A", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) },
        { id: "b", label: "Item B", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) },
        { id: "c", label: "Item C", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) },
        { id: "d", label: "Item D", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Document20Regular, {}) }
      ]
    }
  };
  ...
  var Default2 = (
    /* Default */
    compose(Tree_stories_exports, "Default")
  );
  var SingleSelect2 = (
    /* Single Select */
    compose(Tree_stories_exports, "SingleSelect")
  );
  var MultiSelect2 = (
    /* Multi Select */
    compose(Tree_stories_exports, "MultiSelect")
  );
  var Small2 = (
    /* Small */
    compose(Tree_stories_exports, "Small")
  );
  var FlatList2 = (
    /* Flat List */
    compose(Tree_stories_exports, "FlatList")
  );
  return __toCommonJS(Tree_exports);
})();
