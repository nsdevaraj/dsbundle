...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/Menu.tsx
  var Menu_exports = {};
  __export(Menu_exports, {
    Default: () => Default2,
    IconTrigger: () => IconTrigger2,
    WithDisabledItems: () => WithDisabledItems2,
    WithDivider: () => WithDivider2,
    WithGroupHeaders: () => WithGroupHeaders2,
    WithShortcuts: () => WithShortcuts2
  });
  init_define_import_meta_env();
  var React4 = __toESM(require_react_shim());

  // src/stories/Menu.stories.tsx
  var Menu_stories_exports = {};
  __export(Menu_stories_exports, {
    Default: () => Default,
    IconTrigger: () => IconTrigger,
    WithDisabledItems: () => WithDisabledItems,
    WithDivider: () => WithDivider,
    WithGroupHeaders: () => WithGroupHeaders,
    WithShortcuts: () => WithShortcuts,
    default: () => Menu_stories_default
  });
  init_define_import_meta_env();
...
Source string: ${className}`);
  ...
  init_define_import_meta_env();
  var Edit20Regular = /* @__PURE__ */ createFluentIcon("Edit20Regular", "20", ["M17.18 2.93a2.97 2.97 0 0 0-4.26-.06l-9.37 9.38c-.33.33-.56.74-.66 1.2l-.88 3.94a.5.5 0 0 0 .6.6l3.93-.87c.46-.1.9-.34 1.23-.68l9.36-9.36a2.97 2.97 0 0 0 .05-4.15Zm-3.55.65a1.97 1.97 0 1 1 2.8 2.8l-.68.66-2.8-2.79.68-.67Zm-1.38 1.38 2.8 2.8-7.99 7.97c-.2.2-.46.35-.74.41l-3.16.7.7-3.18c.07-.27.2-.51.4-.7l8-8Z"]);

  // node_modules/@fluentui/react-icons/lib/sizedIcons/chunk-27.js
  init_define_import_meta_env();
  var Delete20Regular = /* @__PURE__ */ createFluentIcon("Delete20Regular", "20", ["M8.5 4h3a1.5 1.5 0 0 0-3 0Zm-1 0a2.5 2.5 0 0 1 5 0h5a.5.5 0 0 1 0 1h-1.05l-1.2 10.34A3 3 0 0 1 12.27 18H7.73a3 3 0 0 1-2.98-2.66L3.55 5H2.5a.5.5 0 0 1 0-1h5ZM5.74 15.23A2 2 0 0 0 7.73 17h4.54a2 2 0 0 0 1.99-1.77L15.44 5H4.56l1.18 10.23ZM8.5 7.5c.28 0 .5.22.5.5v6a.5.5 0 0 1-1 0V8c0-.28.22-.5.5-.5ZM12 8a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V8Z"]);
  ...
  var ds_Menu_default = g2["Menu"] !== void 0 ? g2["Menu"] : g2;

  // src/stories/Menu.stories.tsx
  var import_jsx_runtime3 = __toESM(require_react_shim());
  var meta = {
    title: "Components/Menu",
    component: ds_Menu_exports.Menu,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var Menu_stories_default = meta;
  var basicItems = [
    { id: "edit", label: "Edit", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Edit20Regular, {}) },
    { id: "copy", label: "Copy", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Copy20Regular, {}) },
    { id: "delete", label: "Delete", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Delete20Regular, {}), danger: true }
  ];
  var Default = {
    args: {
      trigger: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ds_Button_exports.Button, { appearance: "secondary", children: "Open menu" }),
      items: basicItems
    }
  };
  var WithDivider = {
    args: {
      trigger: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ds_Button_exports.Button, { appearance: "secondary", children: "Actions" }),
      items: [
        { id: "edit", label: "Edit", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Edit20Regular, {}) },
        { id: "copy", label: "Copy", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Copy20Regular, {}) },
  ...
  var WithShortcuts = {
    args: {
      trigger: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ds_Button_exports.Button, { appearance: "secondary", children: "Edit" }),
      items: [
  ...
  var WithGroupHeaders = {
    args: {
      trigger: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ds_Button_exports.Button, { appearance: "secondary", children: "File" }),
      items: [
  ...
  var WithDisabledItems = {
    args: {
      trigger: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ds_Button_exports.Button, { appearance: "secondary", children: "Options" }),
      items: [
  ...
  var IconTrigger = {
    args: {
      trigger: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ds_Button_exports.Button, { appearance: "subtle", icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MoreHorizontal20Regular, {}), "aria-label": "More actions" }),
      items: basicItems
    }
  };
  ...
  var Default2 = (
    /* Default */
    compose(Menu_stories_exports, "Default")
  );
  var WithDivider2 = (
    /* With Divider */
    compose(Menu_stories_exports, "WithDivider")
  );
  var WithShortcuts2 = (
    /* With Shortcuts */
    compose(Menu_stories_exports, "WithShortcuts")
  );
  var WithGroupHeaders2 = (
    /* With Group Headers */
    compose(Menu_stories_exports, "WithGroupHeaders")
  );
  var WithDisabledItems2 = (
    /* With Disabled Items */
    compose(Menu_stories_exports, "WithDisabledItems")
  );
  var IconTrigger2 = (
    /* Icon Trigger */
    compose(Menu_stories_exports, "IconTrigger")
  );
