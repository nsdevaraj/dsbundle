...
var __dsPreview = (() => {
  ...
  var meta = {
    ...
    parameters: {
      docs: {
        description: {
          component: "Slider lets users select a value from a continuous or stepped range by dragging a thumb along a track. Best for settings perceived as relative quantities rather than exact numbers — like volume, brightness, or zoom."
        }
      }
    },
    argTypes: {
  ...
  var WithValue2 = (
    /* With Value */
    compose(Slider_stories_exports, "WithValue")
  );
  var CustomRange2 = (
    /* Custom Range */
    compose(Slider_stories_exports, "CustomRange")
  );
  var Small2 = (
    /* Small */
    compose(Slider_stories_exports, "Small")
  );
  var Disabled2 = (
    /* Disabled */
    compose(Slider_stories_exports, "Disabled")
  );
  var WithValidation2 = (
    /* With Validation */
    compose(Slider_stories_exports, "WithValidation")
  );
