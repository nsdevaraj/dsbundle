...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/InteractionTag.tsx
  var InteractionTag_exports = {};
  __export(InteractionTag_exports, {
    Brand: () => Brand2,
    Default: () => Default2,
  ...
  // src/stories/InteractionTag.stories.tsx
  var InteractionTag_stories_exports = {};
  __export(InteractionTag_stories_exports, {
    Brand: () => Brand,
    Default: () => Default,
    ...
    Outline: () => Outline,
    WithIcons: () => WithIcons,
    default: () => InteractionTag_stories_default
  });
  init_define_import_meta_env();
...
Source string: ${className}`);
  ...
  var ds_InteractionTag_default = g["InteractionTag"] !== void 0 ? g["InteractionTag"] : g;

  // src/stories/InteractionTag.stories.tsx
  var import_jsx_runtime3 = __toESM(require_react_shim());
  var meta = {
    title: "Components/InteractionTag",
    component: ds_InteractionTag_exports.InteractionTag,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var InteractionTag_stories_default = meta;
  var __renderITag = (t, extra) => (0, import_jsx_runtime3.jsx)(
    ds_InteractionTag_exports.InteractionTag,
    { value: t.value, ...extra, children: t.label },
    t.value
  );
  var __renderITGroup = (groupProps, tags, extra) => (0, import_jsx_runtime3.jsx)(
    ds_InteractionTag_exports.InteractionTagGroup,
    { ...groupProps, children: tags.map((t) => __renderITag(t, extra)) }
  );
  var Default = {
    render: () => __renderITGroup(
  ...
  var WithIcons = {
    render: () => __renderITGroup(
      ...
      { icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Person20Regular, {}) }
    )
  };
  var Dismissible = {
    render: () => {
      ...
      return __renderITGroup(
        { "aria-label": "Dismissible tags" },
        tags,
        { onDismiss: (value) => setTags((cur) => cur.filter((tag) => tag.value !== value)) }
      );
    }
  };
  var Outline = {
  ...
  var ExtraSmall = {
    render: () => __renderITGroup(
      { "aria-label": "Tags", size: "extra-small" },
      [
        { value: "a", label: "Tag A" },
        { value: "b", label: "Tag B" },
        { value: "c", label: "Tag C" }
  ...
  var Default2 = (
    /* Default */
    compose(InteractionTag_stories_exports, "Default")
  );
  var WithIcons2 = (
    /* With Icons */
    compose(InteractionTag_stories_exports, "WithIcons")
  );
  var Dismissible2 = (
    /* Dismissible */
    compose(InteractionTag_stories_exports, "Dismissible")
  );
  var Outline2 = (
    /* Outline */
    compose(InteractionTag_stories_exports, "Outline")
  );
  var Brand2 = (
    /* Brand */
    compose(InteractionTag_stories_exports, "Brand")
  );
  var ExtraSmall2 = (
    /* Extra Small */
    compose(InteractionTag_stories_exports, "ExtraSmall")
  );
  return __toCommonJS(InteractionTag_exports);
})();
