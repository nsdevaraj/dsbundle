...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/MenuButton.tsx
  var MenuButton_exports = {};
  __export(MenuButton_exports, {
    Disabled: () => Disabled2,
    Primary: () => Primary2,
  ...
  var MenuButton_stories_exports = {};
  __export(MenuButton_stories_exports, {
    Disabled: () => Disabled,
    Primary: () => Primary,
    Secondary: () => Secondary,
    Small: () => Small,
    WithIcon: () => WithIcon,
    default: () => MenuButton_stories_default
  });
  init_define_import_meta_env();
...
Source string: ${className}`);
  ...
  init_define_import_meta_env();
  var ChevronDown20Regular = /* @__PURE__ */ createFluentIcon("ChevronDown20Regular", "20", ["M15.85 7.65c.2.2.2.5 0 .7l-5.46 5.49a.55.55 0 0 1-.78 0L4.15 8.35a.5.5 0 1 1 .7-.7L10 12.8l5.15-5.16c.2-.2.5-.2.7 0Z"]);
  ...
  var ds_MenuButton_default = g["MenuButton"] !== void 0 ? g["MenuButton"] : g;

  // src/stories/MenuButton.stories.tsx
  var import_jsx_runtime3 = __toESM(require_react_shim());
  var meta = {
    title: "Components/MenuButton",
    component: ds_MenuButton_exports.MenuButton,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
  ...
  var MenuButton_stories_default = meta;
  var items = [
    { id: "save", label: "Save" },
  ...
  var WithIcon = {
    args: {
      label: "Actions",
      appearance: "primary",
      icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ChevronDown20Regular, {}),
      items
    }
  };
  var Disabled = {
  ...
  var Primary2 = (
    /* Primary */
    compose(MenuButton_stories_exports, "Primary")
  );
  var Secondary2 = (
    /* Secondary */
    compose(MenuButton_stories_exports, "Secondary")
  );
  var WithIcon2 = (
    /* With Icon */
    compose(MenuButton_stories_exports, "WithIcon")
  );
  var Disabled2 = (
    /* Disabled */
    compose(MenuButton_stories_exports, "Disabled")
  );
  var Small2 = (
    /* Small */
    compose(MenuButton_stories_exports, "Small")
  );
  return __toCommonJS(MenuButton_exports);
})();
