...
var __dsPreview = (() => {
  ...
  __export(Icon_exports, {
    Brand: () => Brand2,
    Danger: () => Danger2,
    Decorative: () => Decorative2,
    Large: () => Large2,
    Meaningful: () => Meaningful2,
    Warning: () => Warning2
  });
  init_define_import_meta_env();
...
Source string: ${className}`);
  ...
  var createFluentIcon = (displayName, width, pathsOrSvg, options) => {
    ...
    const Icon2 = React3.forwardRef((props, ref) => {
  ...
  var Decorative = { args: { icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Add20Regular, {}), color: "default" } };
  var Meaningful = { args: { icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Add20Regular, {}), "aria-label": "Add item" } };
  var Brand = { args: { icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Heart20Regular, {}), color: "brand" } };
  var Warning = { args: { icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Warning20Regular, {}), color: "warning", size: 24 } };
  var Danger = { args: { icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Warning20Regular, {}), color: "danger" } };
  var Large = { args: { icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Add20Regular, {}), size: 32, color: "brand" } };
  ...
  var Decorative2 = (
    /* Decorative */
    compose(Icon_stories_exports, "Decorative")
  );
  var Meaningful2 = (
    /* Meaningful */
    compose(Icon_stories_exports, "Meaningful")
  );
  var Brand2 = (
    /* Brand */
    compose(Icon_stories_exports, "Brand")
  );
  var Warning2 = (
    /* Warning */
    compose(Icon_stories_exports, "Warning")
  );
  var Danger2 = (
    /* Danger */
    compose(Icon_stories_exports, "Danger")
  );
  var Large2 = (
    /* Large */
    compose(Icon_stories_exports, "Large")
  );
