...
var __dsPreview = (() => {
  ...
  // .design-sync/.cache/previews/DatePicker.tsx
  var DatePicker_exports = {};
  __export(DatePicker_exports, {
    AllowTextInput: () => AllowTextInput2,
    Default: () => Default2,
    ErrorState: () => ErrorState2,
    MondayStart: () => MondayStart2,
    Required: () => Required2,
    WithMinMax: () => WithMinMax2
  });
  init_define_import_meta_env();
  var React = __toESM(require_react_shim());

  // src/stories/DatePicker.stories.tsx
  var DatePicker_stories_exports = {};
  __export(DatePicker_stories_exports, {
    ...
    default: () => DatePicker_stories_default
  });
  init_define_import_meta_env();
  ...
  var meta = {
    ...
    component: ds_DatePicker_exports.DatePicker,
    tags: ["autodocs"],
    parameters: {
      docs: {
        description: {
          component: "DatePicker is a popup calendar control (from @fluentui/react-datepicker-compat) for selecting a single date. It shows a calendar view where day-of-week context is important — ideal for appointments, scheduling, and date-range bounded inputs."
        }
      }
    },
    argTypes: {
  ...
  var DatePicker_stories_default = meta;
  var Default = {
  ...
  var WithMinMax = {
    args: {
      ...
      maxDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1e3),
  ...
  var Default2 = (
    /* Default */
    compose(DatePicker_stories_exports, "Default")
  );
  var Required2 = (
    /* Required */
    compose(DatePicker_stories_exports, "Required")
  );
  var WithMinMax2 = (
    /* With Min Max */
    compose(DatePicker_stories_exports, "WithMinMax")
  );
  var AllowTextInput2 = (
    /* Allow Text Input */
    compose(DatePicker_stories_exports, "AllowTextInput")
  );
  var ErrorState2 = (
    /* Error State */
    compose(DatePicker_stories_exports, "ErrorState")
  );
  var MondayStart2 = (
    /* Monday Start */
    compose(DatePicker_stories_exports, "MondayStart")
  );
