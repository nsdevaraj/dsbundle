...
var __dsPreview = (() => {
  ...
  __export(ProgressBar_exports, {
    ...
    Success: () => Success2,
    Warning: () => Warning2,
    WithPercentage: () => WithPercentage2
  });
  init_define_import_meta_env();
  ...
  var ProgressBar_stories_default = meta;
  var Default = {
  ...
  var Default2 = (
    /* Default */
    compose(ProgressBar_stories_exports, "Default")
  );
  var WithPercentage2 = (
    /* With Percentage */
    compose(ProgressBar_stories_exports, "WithPercentage")
  );
  var Indeterminate2 = (
    /* Indeterminate */
    compose(ProgressBar_stories_exports, "Indeterminate")
  );
  var Success2 = (
    /* Success */
    compose(ProgressBar_stories_exports, "Success")
  );
  var Error3 = (
    /* Error */
    compose(ProgressBar_stories_exports, "Error")
  );
  var Warning2 = (
    /* Warning */
    compose(ProgressBar_stories_exports, "Warning")
  );
  var Large2 = (
    /* Large */
    compose(ProgressBar_stories_exports, "Large")
  );
