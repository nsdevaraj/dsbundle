...
var __dsPreview = (() => {
  ...
  __export(TimePicker_exports, {
    AllValidationStates: () => AllValidationStates2,
    BusinessHoursOnly: () => BusinessHoursOnly2,
    DarkMode: () => DarkMode2,
    Default: () => Default2,
    Disabled: () => Disabled2,
    Error: () => Error3,
    FifteenMinuteIncrements: () => FifteenMinuteIncrements2,
    FilledDarker: () => FilledDarker2,
    Required: () => Required2,
    Small: () => Small2,
    Success: () => Success2,
    TwelveHourClock: () => TwelveHourClock2,
  ...
  var TimePicker_stories_exports = {};
  __export(TimePicker_stories_exports, {
    AllValidationStates: () => AllValidationStates,
    BusinessHoursOnly: () => BusinessHoursOnly,
    DarkMode: () => DarkMode,
    Default: () => Default,
    Disabled: () => Disabled,
    Error: () => Error2,
    FifteenMinuteIncrements: () => FifteenMinuteIncrements,
    ...
    Warning: () => Warning,
    WithHint: () => WithHint,
    default: () => TimePicker_stories_default
  });
  init_define_import_meta_env();
...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  var ds_TimePicker_default = g["TimePicker"] !== void 0 ? g["TimePicker"] : g;
  ...
  var meta = {
    ...
    parameters: {
      docs: {
        description: {
          component: "TimePicker is a dropdown/freeform input (from @fluentui/react-timepicker-compat) for selecting a time value. Supports 12-hour and 24-hour clock formats and configurable minute increments such as every 15 or 30 minutes."
        }
      }
    },
    argTypes: {
  ...
  var TimePicker_stories_default = meta;
  var Default = {
    args: {
      label: "Meeting time",
  ...
  var DarkMode = {
    decorators: [
      (Story) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme: darkTheme, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { padding: "1rem", width: "280px" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Story, {}) }) })
    ],
    args: {
      label: "Meeting time",
      placeholder: "Select a time"
  ...
  var AllValidationStates = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "16px", width: "300px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_TimePicker_exports.TimePicker, { label: "Default", placeholder: "Select a time" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_TimePicker_exports.TimePicker, { label: "Error", validationState: "error", validationMessage: "Required field.", placeholder: "Select a time" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_TimePicker_exports.TimePicker, { label: "Warning", validationState: "warning", validationMessage: "Conflicts with another booking.", placeholder: "Select a time" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_TimePicker_exports.TimePicker, { label: "Success", validationState: "success", validationMessage: "Slot available.", placeholder: "Select a time" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_TimePicker_exports.TimePicker, { label: "Disabled", disabled: true, placeholder: "Select a time" })
    ] })
  };
  ...
  var Default2 = (
    /* Default */
    compose(TimePicker_stories_exports, "Default")
  );
  var TwelveHourClock2 = (
    /* Twelve Hour Clock */
    compose(TimePicker_stories_exports, "TwelveHourClock")
  );
  var FifteenMinuteIncrements2 = (
    /* Fifteen Minute Increments */
    compose(TimePicker_stories_exports, "FifteenMinuteIncrements")
  );
  var BusinessHoursOnly2 = (
    /* Business Hours Only */
    compose(TimePicker_stories_exports, "BusinessHoursOnly")
  );
  var Required2 = (
    /* Required */
    compose(TimePicker_stories_exports, "Required")
  );
  var WithHint2 = (
    /* With Hint */
    compose(TimePicker_stories_exports, "WithHint")
  );
  var Error3 = (
    /* Error */
    compose(TimePicker_stories_exports, "Error")
  );
  var Warning2 = (
    /* Warning */
    compose(TimePicker_stories_exports, "Warning")
  );
  var Success2 = (
    /* Success */
    compose(TimePicker_stories_exports, "Success")
  );
  var Disabled2 = (
    /* Disabled */
    compose(TimePicker_stories_exports, "Disabled")
  );
  var Small2 = (
    /* Small */
    compose(TimePicker_stories_exports, "Small")
  );
  var Underline2 = (
    /* Underline */
    compose(TimePicker_stories_exports, "Underline")
  );
  var FilledDarker2 = (
    /* Filled Darker */
    compose(TimePicker_stories_exports, "FilledDarker")
  );
  var DarkMode2 = (
    /* Dark Mode */
    compose(TimePicker_stories_exports, "DarkMode")
  );
  var AllValidationStates2 = (
    /* All Validation States */
    compose(TimePicker_stories_exports, "AllValidationStates")
  );
