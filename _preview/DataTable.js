...
var __dsPreview = (() => {
  ...
  __export(DataTable_exports, {
    ...
    Empty: () => Empty2,
    Loading: () => Loading2,
    WithPagination: () => WithPagination2,
    WithSelection: () => WithSelection2
  });
  init_define_import_meta_env();
...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  var columns = [
    { columnId: "name", label: "Name", renderCell: (u) => u.name, sortable: true },
    { columnId: "role", label: "Role", renderCell: (u) => u.role, sortable: true },
    { columnId: "status", label: "Status", renderCell: (u) => u.status },
    { columnId: "joined", label: "Joined", renderCell: (u) => u.joined, sortable: true }
  ];
  var meta = {
  ...
  var Default = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_DataTable_exports.DataTable, { items: users, columns })
  };
  var WithSelection = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_DataTable_exports.DataTable, { items: users, columns, selectionMode: "multiselect" })
  };
  var WithPagination = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_DataTable_exports.DataTable, { items: users, columns, pageSize: 2 })
  };
  var Loading = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_DataTable_exports.DataTable, { items: users, columns, loading: true })
  };
  var Empty = {
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ds_DataTable_exports.DataTable, { items: [], columns, emptyMessage: "No users found" })
  };
  var DarkMode = {
    decorators: [(Story) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(FluentProvider, { theme: darkTheme, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { padding: "1rem" }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Story, {}) }) })],
    render: () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      ds_DataTable_exports.DataTable,
      {
        columns: [
          { columnId: "name", label: "Name", renderCell: (r) => r.name, sortable: true },
          { columnId: "role", label: "Role", renderCell: (r) => r.role }
        ],
        items: [
  ...
  var WithSelection2 = (
    /* With Selection */
    compose(DataTable_stories_exports, "WithSelection")
  );
  var WithPagination2 = (
    /* With Pagination */
    compose(DataTable_stories_exports, "WithPagination")
  );
  var Loading2 = (
    /* Loading */
    compose(DataTable_stories_exports, "Loading")
  );
  var Empty2 = (
    /* Empty */
  ...
  var DarkMode2 = (
    /* Dark Mode */
    compose(DataTable_stories_exports, "DarkMode")
  );
