...
var __dsPreview = (() => {
  ...
  __export(Card_exports, {
    ...
    Default: () => Default2,
    FilledAlternative: () => FilledAlternative2,
    Small: () => Small2,
    Subtle: () => Subtle2,
  ...
  __export(Card_stories_exports, {
    Clickable: () => Clickable,
    Default: () => Default,
    FilledAlternative: () => FilledAlternative,
    Small: () => Small,
    Subtle: () => Subtle,
...
You can check this by searching up for matching entries in a lockfile produced by your package manager (yarn.lock, pnpm-lock.yaml or package-lock.json).`);
  ...
  var Default = {
    args: {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: { margin: 0 }, children: "A project card with header and body content." })
    }
  };
  var WithFooter = {
    args: {
      header: { title: "Report Q1", subtitle: "Finance" },
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: { margin: 0 }, children: "Quarterly financial summary." }),
      footer: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button, { appearance: "primary", size: "small", children: "View report" })
    }
  };
  var FilledAlternative = {
    args: {
      header: { title: "Task Board" },
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: { margin: 0 }, children: "filled-alternative appearance card." }),
  ...
  var Subtle = {
    args: {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: { margin: 0 }, children: "Subtle appearance." }),
      appearance: "subtle"
    }
  };
  var Clickable = {
    args: {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: { margin: 0 }, children: "Click anywhere on this card." }),
  ...
  var Small = {
    args: {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: { margin: 0 }, children: "Small size variant." }),
      size: "small"
    }
  };
  ...
  function compose(S, key) {
    ...
    if (st && typeof st.render === "function") render = () => st.render(args, ctx);
      ...
      if (C) render = () => React10.createElement(C, args);
    }
  ...
  var WithFooter2 = (
    /* With Footer */
    compose(Card_stories_exports, "WithFooter")
  );
  var FilledAlternative2 = (
    /* Filled Alternative */
    compose(Card_stories_exports, "FilledAlternative")
  );
  var Subtle2 = (
    /* Subtle */
    compose(Card_stories_exports, "Subtle")
  );
  var Clickable2 = (
    /* Clickable */
    compose(Card_stories_exports, "Clickable")
  );
  var Small2 = (
    /* Small */
    compose(Card_stories_exports, "Small")
  );
